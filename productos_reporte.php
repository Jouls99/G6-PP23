...
<head>
  ...
  <meta charset="utf-8">
  <title>Dir. Arquitectura - Articulos - Vista</title>
  ...
  <div class="container">
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <span class="productolabel">Cód. Artículo:</span>
        ...
        <span class="productolabel">Cantidad Artículos:</span>
        <span class="productodato"><?php echo number_format($row2['cantidad_producto'], 2, ',', '.') ?></span>
        <br />

        <span class="productolabel">Cantidad Entregada:</span>
